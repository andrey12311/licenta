...
public class SecurityConstants {
    public static final long EXPIRATION_TIME = 864_000_000;// 5 days expressed in milliseconds
    ...
    public static final String[] PUBLIC_URLS =
            {"/login-api/**","/register-api/*","/anunturi-api/anunturi",
                    "/anunturi-api/anunturi/*", "/anunturi-api/image/**","/forgot-api/**","/anunturi-api/anunturii-active",
            "/anunturi-api/count-anunturi"};
//public static final String[] PUBLIC_URLS = {"**"};
}
